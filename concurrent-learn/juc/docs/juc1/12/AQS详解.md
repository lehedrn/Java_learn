...
```
HEAD(虚节点)          Node1              Node2              Node3
+------------+    +------------+    +------------+    +------------+
| waitStatus |    | waitStatus |    | waitStatus |    | waitStatus |
|    0       |    |   -1(SIGNAL)|    |   -1(SIGNAL)|    |    0       |
+------------+    +------------+    +------------+    +------------+
...
线程 A 尝试获取锁的过程如下图所示（图源[从 ReentrantLock 的实现看 AQS 的原理及应用 - 美团技术团队](https://tech.meituan.com/2019/12/05/aqs-theory-and-apply.html)）：
